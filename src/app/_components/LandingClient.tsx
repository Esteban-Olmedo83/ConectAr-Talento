              ...
              <div key={col.title}>
                ...
                <ul className="space-y-2 text-sm">
                  {col.links.map(l => (
                    <li key={l.label}>
                      {l.href.startsWith('/') ? (
                        <Link href={l.href} style={{ color: 'rgba(255,255,255,0.4)' }} className="hover:text-white transition-colors">{l.label}</Link>
                      ) : (
                        <a href={l.href} style={{ color: 'rgba(255,255,255,0.4)' }} className="hover:text-white transition-colors">{l.label}</a>
                      )}
                    </li>
                  ))}
                </ul>
