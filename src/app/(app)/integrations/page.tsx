  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
        ...
        {/* 4. WhatsApp */}
        <Section icon={<MessageCircle className="h-5 w-5 text-green-600" />} title="WhatsApp" subtitle="Mensajes directos a candidatos">
          <div className="space-y-3">
            <div className="rounded-lg p-4 space-y-2.5" style={{ background: 'var(--surface2)', border: '1px solid var(--border)' }}>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-green-500 shrink-0" />
                <p className="text-xs font-semibold" style={{ color: 'var(--text)' }}>Ya funciona — sin configuración extra</p>
              </div>
              <p className="text-xs leading-relaxed" style={{ color: 'var(--muted)' }}>
                Desde el Pipeline podés hacer clic en el ícono de WhatsApp en cualquier candidato. La app copia el mensaje al portapapeles y abre la conversación directamente. Solo pegás el texto y enviás.
              </p>
              <p className="text-xs leading-relaxed" style={{ color: 'var(--muted)' }}>
                Este método funciona con <strong style={{ color: 'var(--text)' }}>cualquier número de WhatsApp personal o empresarial</strong>, sin necesidad de contratos ni verificaciones.
              </p>
            </div>
            <div className="rounded-lg p-3 flex gap-2.5" style={{ background: 'rgba(251,191,36,0.06)', border: '1px solid rgba(251,191,36,0.15)' }}>
              ...
              <p className="text-xs leading-relaxed" style={{ color: 'var(--muted)' }}>
                <strong style={{ color: 'var(--text)' }}>WhatsApp Business API (Meta):</strong> requiere número dedicado, verificación de negocio en Meta y aprobación del caso de uso. Proceso de semanas, no apto para la mayoría de los equipos. No lo incluimos para no prometer algo que no funciona.
              </p>
            </div>
          </div>
        </Section>
                ...
                <div key={jb.platform} className="border border-border rounded-xl p-3 flex flex-col items-center gap-2 text-center hover:shadow-sm transition-shadow">
                  ...
                  {jb.url ? (
                    <a
                      ...
                      className="text-xs bg-primary/10 text-primary hover:bg-primary/20 px-2 py-1 rounded-lg transition-colors flex items-center gap-1"
                    >
                      <ExternalLink className="h-2.5 w-2.5" /> Publicar
                    </a>
                  ) : (
                    <span className="text-xs text-muted-foreground bg-muted px-2 py-0.5 rounded-full">
                      Próximamente
